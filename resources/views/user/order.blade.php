<x-layout-user>
    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      @if ($orders->isEmpty())
        <div class="mt-10 text-center text-gray-500 dark:text-gray-300">
          <p>Kamu belum memiliki Order</p>
        </div>
      @else
                    ...
                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                      ...
                      <div class="flex items-center gap-4">
                        <button type="button"
                          ...
                          data-images='@json($o->product->images)'
                          data-modal-target="PreviewModal"
                          data-modal-toggle="PreviewModal"
                          class="btn-preview inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 hover:underline dark:text-gray-400 dark:hover:text-white">
                        ...
                        <form class="flex items-center" action="{{ route('user.delete.order', $o->id) }}" method="POST">
                          ...
                          <button type="submit" class="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                            <svg class="me-1.5 h-5 w-5" aria-hidden="true" fill="none" viewBox="0 0 24 24">
            ...
            <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              ...
              <div class="space-y-4">
                <dl class="flex justify-between">
                  ...
                  <dd class="text-gray-900 dark:text-white">Tn. {{ $orders->first()->name }}</dd>
                </dl>
                <dl class="flex justify-between">
                  <dt class="text-gray-500 dark:text-gray-400">Email</dt>
                  <dd class="text-gray-900 dark:text-white">{{ $orders->first()->email }}</dd>
                </dl>
                <dl class="flex justify-between">
                  <dt class="text-gray-500 dark:text-gray-400">Phone</dt>
                  <dd class="text-gray-900 dark:text-white">{{ $orders->first()->phone }}</dd>
                </dl>
