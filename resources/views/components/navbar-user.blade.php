        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/user-katalog" :active="request()->is('user-katalog')">Katalog</x-nav-link>
              <x-nav-link href="/user-order" :active="request()->is('user-order')">Orders</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
