<nav class="bg-gray-800" x-data="{isOpen:false}">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/admin-produk" :active="request()->is('admin-produk')">Produk</x-nav-link>
              <x-nav-link href="/admin-member" :active="request()->is('admin-member')">Member</x-nav-link>
              <x-nav-link href="/admin-order" :active="request()->is('admin-order')">Order</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              <div 
                ...
                <button href="#" class="block w-full text-left rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</button>
                <button href="#" class="block w-full text-left rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</button>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <x-nav-link href="/admin/dashboard" :active="request()->is('admin/dashboard')">Dashboard</x-nav-link>
              <x-nav-link href="/admin/jadwal" :active="request()->is('admin/jadwal')">Jadwal Kegiatan</x-nav-link>
              <x-nav-link href="/admin/member" :active="request()->is('admin/member')">Member</x-nav-link>
              <x-nav-link href="/admin/reservasi" :active="request()->is('admin/reservasi')">Reservasi</x-nav-link>
      </div>
